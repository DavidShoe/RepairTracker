...
{
    public class ClientRepairsViewModel
    {
        private readonly GameRepairContext _context;
        public ClientRepairsViewModel(GameRepairContext context)
        {
            _context = context;
        }
    ...
    public class ClientRepairsController : Controller
    {
        private readonly GameRepairContext _context;

        public ClientRepairsController(GameRepairContext context)
        {
            _context = context;
        }
        ...
        // GET: ClientRepairs/ClientRepairsIndex
        public IActionResult ClientRepairsIndex()
        {
            ...
            var repairsViewModel = new ClientRepairsViewModel(_context);
            ...
            repairsViewModel.Addresses = addresses;
            return View(repairsViewModel);
        }

        [HttpGet]
        public async Task<IActionResult> ClientWorkOnRepair(int id)
        {
        ...
        public async Task<IActionResult> Start(int id)
        {
            ...
            return View(nameof(ClientWorkOnRepair), repair);
        }
        ...
        public async Task<IActionResult> Create([Bind("RepairId,GameId,TechnicianId,FinishedDate,ReceivedDate,OwnerId,StartDate,CustomerStates")] Repair repair)
        {
            ...
            if (ModelState.IsValid)
            {
                _context.Add(repair);
                await _context.SaveChangesAsync();
                return RedirectToAction(nameof(ClientRepairsIndex));
            }
